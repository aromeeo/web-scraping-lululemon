...
# Create csv file
csv_file = open('mensrunning_lululemon.csv', 'w')
    ...
    while True:
        try:
            ...
            for review in reviews:
                ...
                review_dict['productCategory'] = productCategory
                review_dict['productCategoryDetail'] = productCategoryDetail
                ...
                # Write all dictionary key-value pairs to csv  
                # This is the end of the current page of reviews
        ...
        # Catch the error, break, and move to the next product URL
        except NoSuchElementException:
