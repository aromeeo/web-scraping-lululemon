...
driver.get("https://shop.lululemon.com/c/women/run/_/N-7vfZ1z141cp?Nrpp=9&icid=US")
...
### Create csv file ###
csv_file = open('lululemonF2_61.csv', 'w')
...
product_index = 61 ## Keep track of what product we are on

### Loop through each product's URL ###
for item in product_urls[60:80]:
    driver.get(item)
    time.sleep(6)
